...
const COLUMNS = ["Intake", "Assessment", "Active", "Monitoring", "Closed"] as const;

const COLUMN_COLORS: Record<string, string> = {
  Intake: "bg-blue-500/10 border-blue-500/30",
  Assessment: "bg-yellow-500/10 border-yellow-500/30",
  Active: "bg-green-500/10 border-green-500/30",
  Monitoring: "bg-purple-500/10 border-purple-500/30",
...
export function CasePipelineKanban() {
  const cases = useQuery(api.cases.listByStatus);
